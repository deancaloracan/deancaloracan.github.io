...
import { FaCode, FaCodeBranch, FaViber, FaRProject, FaCss3Alt } from 'react-icons/fa';
import { DiPython } from 'react-icons/di';
import { SiAngularjs, SiPowerapps, SiPowerautomate, SiJavascript, SiReact, SiCsharp, SiAdobephotoshop, SiAdobepremierepro, SiCanva, SiGmail, SiTableau, SiMui, SiPowerbi, SiMysql, SiMicrosoftsqlserver } from 'react-icons/si';
    ...
    <main className='bg-white px-10 text-black'>
     ...
     <section className='p-10 bg-gradient-to-r from-orange-400 to-rose-400'>
          ...
          <div>
            ...
            Since the beginning of my journey as a developer and data analyst, I have done work for government agencies, for startups and collaborated with many leaders and innovators to create digital products  and solutions.
            </p>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
            I offer from a wide range of services, including project management, data  management and analysis, programming and teaching.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 dark:text-white">
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >Database Administration</h3>
            <ul>
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >Programming Languages</h3>
            <ul>
              <li>Python</li>
              <li>R</li>
              <li>C#</li>
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >Web Development and Design</h3>
            <ul>
              <li>HTML</li>
              <li>CSS</li>
              <li>JS</li>
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >UI Frameworks</h3>
            <ul>
              <li>Next.js</li>
              <li>AngularJS</li>
              <li>ReactJS</li>
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >Styling</h3>
            <ul>
              <li>TailwindCSS</li>
              <li>MUI</li>
            </ul>
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >Productivity Tools</h3>
            <ul>
          ...
          <div> 
            <h3 className="text-xl py-1 dark:text-white font-bold" >Automation Tools</h3>
            <ul>
              <li>Apps Script</li>
          ...
          <div>
            <h3 className="text-xl py-1 dark:text-white font-bold" >Multimedia Tools</h3>
            <ul>
      ...
      <section className='py-4'>
          <h3 className="text-3xl py-3 dark:text-white font-bold">Projects I Managed</h3>
      ...
      />
            ...
            <h3 className="text-3xl py-4 dark:text-white font-bold">Projects I Developed</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-3">
